...
const CommunityUpdate = () => {
    ...
    <div className='mt-10 h-auto'>
        ...
        <div className="flex flex-col items-center justify-center text-center mx-auto w-full">
            <Title text={"Caring is the new marketing"} fontSize="36px" color="#4D4D4D" align="center" />
        ...
        <div className='mt-15 w-full max-w-[1152px] flex flex-wrap justify-center md:justify-between items-center mx-auto gap-10 md:gap-0'>
            <div className='relative flex flex-col items-center max-w-[285px]'>
                <img src={CommunityUpdate1} alt='Logo CommunityUpdate1' className="h-auto max-h-[286px] max-w-[368px]" />
                ...
                <Title text={"Creating Streamlined Safeguarding Processes with OneRen"} fontSize="20px" color="#4D4D4D" align="center" />
            ...
            <div className='relative flex flex-col items-center max-w-[285px]'>
                <img src={CommunityUpdate2} alt='Logo CommunityUpdate2' className="h-auto max-h-[286px] max-w-[368px]" />
                <div className='absolute bottom-[-20px] left-1/2 transform -translate-x-1/2 bg-[#F5F7FA] rounded-lg p-5 shadow-lg w-[110%] h-[45%] text-center'>
                <Title text={"What are your safeguarding responsibilities and how can you manage them?"} fontSize="20px" color="#4D4D4D" align="center" />
                <div className='flex justify-center gap-2'>
                <Title text={"Readmore"} fontSize="20px" color="#4CAF4F" align="center" />
                <img src={Right} alt="Right" className="mt-0.5 max-w-[24px] md:max-w-[32px] h-auto" />
                </div>
