...
const Community = () => {
  return (
    ...
    <div className='mt-10 h-115'>
        ...
        <div>
            <p className="font-normal text-[16px] leading-[24px] tracking-[0%] text-center text-[#717171]">Who is Nextcent suitable for?</p>
        </div>
        </div>
        {/**Div contiene Cards */}
        <div className='mt-15 w-[1152px] flex justify-between items-center mx-auto'>
            <div className='flex flex-col items-center'>
            <img src={Community1} alt='Logo Community1' />
            ...
            <p className="font-normal text-[14px] leading-[24px] tracking-[0%] text-center text-[#717171]">Our membership management <br />software provides full automation of <br />membership renewals and payments</p>
            </div>
            <div className='flex flex-col items-center'>
            <img src={Community2} alt='Logo Community2' />
            ...
            <div className='flex flex-col items-center'>
            <img src={Community3} alt='Logo Community3' />
